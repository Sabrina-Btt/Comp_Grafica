...
int main(){
	...
	ImageRGBA tile4("wintertileset/png/Tiles/7_7.png");
	ImageRGBA tile5("wintertileset/png/Tiles/11_11.png");
	ImageRGBA agua1("wintertileset/png/Tiles/17_17.png");
	ImageRGBA agua2("wintertileset/png/Tiles/18_18.png");
    ...
    bg=construtor(bg,tile1,0,200);

    bg=construtor(bg,tile1,100,0);
    bg=construtor(bg,tile1,100,100);
    bg=construtor(bg,tile1,100,200);
    ...
    //Water
    bg=construtor(bg,agua2,0,300);
    bg=construtor(bg,agua1,100,300);
    bg=construtor(bg,agua2,0,400);
    bg=construtor(bg,agua1,100,400);
    bg=construtor(bg,agua2,0,500);
    bg=construtor(bg,agua1,100,500);
    bg=construtor(bg,agua2,0,600);
    bg=construtor(bg,agua1,100,600);
    ...
    //Water
    bg=construtor(bg,agua2,-50,1200);
    bg=construtor(bg,agua2,50,1200);
    bg=construtor(bg,agua2,100,1200);
    bg=construtor(bg,agua1,150,1200);


    //Finish
    bg=construtor(bg,tile1,0,1300);
    bg=construtor(bg,tile1,0,1400);
    bg=construtor(bg,tile1,0,1500);
    bg=construtor(bg,tile1,0,1600);
    bg=construtor(bg,tile1,0,1700);

    bg=construtor(bg,tile1,100,1300);
    ...
    bg=construtor(bg,tile1,200,1300);
    ...
    bg=construtor(bg,tile1,300,1300);
    ...
    bg=construtor(bg,tile4,400,1700);
